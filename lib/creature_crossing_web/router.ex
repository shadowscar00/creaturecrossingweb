defmodule CreatureCrossingWeb.Router do
  ...
  scope "/", CreatureCrossingWeb do
    ...
    live "/", Calculator.IndexLive, :index
  end
  ...
  if Application.compile_env(:creature_crossing_web, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CreatureCrossingWeb.Telemetry
